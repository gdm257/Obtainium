          ...
          child: Column(
            ...
            children: [
              DropdownButtonFormField<CloudBackend>(
                ...
                onChanged: (v) =>
                    setState(() => _active = v ?? CloudBackend.none),
              ),
              const SizedBox(height: 12),
              Text('S3', style: Theme.of(context).textTheme.titleSmall),
              _field(
                's3Endpoint',
                label: tr('cloudBackupS3Endpoint'),
              ...
              _field(
                's3Prefix',
                label: tr('cloudBackupPrefix'),
                hint: 'backups/',
              ),
              _field('s3AccessKey', label: tr('cloudBackupS3AccessKey')),
              _field(
                's3Secret',
                label: tr('cloudBackupS3Secret'),
                obscure: true,
              ),
              const SizedBox(height: 12),
              ...
              _field(
                'webdavPassword',
                label: tr('cloudBackupWebDavPassword'),
                obscure: true,
              ),
            ],
          ),
